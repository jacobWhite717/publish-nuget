...
class Action {
    ...
    _pushPackage(version, name) {
        ...
        const pushCmd = `dotnet nuget push *.nupkg --source ${this.nugetSource} -k e48408e56fb4937fbc6308637d21b5114e7c66cf ${!this.includeSymbols ? "--no-symbols" : ""} --skip-duplicate`,
